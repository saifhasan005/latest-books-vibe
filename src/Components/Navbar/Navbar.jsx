...
const Navbar = () => {
    const  links =(
        <>
            ...
            <li><NavLink to={'/page-to-reload'} className={({isActive})=> isActive?"text-green-500 border border-green-500": ""}>Page Reload</NavLink></li>
        </>
    )
    return (
        <div className='bg-base-100 shadow-sm'>
            <div className="navbar  container mx-auto ">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-[18px] sm:text-xl font-bold">Books Vibe</a>
                </div>
                ...
                <div className="navbar-end">
                    <a className="btn btn-success mr-[25px]">Sign In</a>
